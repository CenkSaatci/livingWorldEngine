...
**Fehlercodes:** `COMBAT_AP_INSUFFICIENT`, `COMBAT_RANGE_INVALID`, `COMBAT_TARGET_INVALID`, `COMBAT_ACTION_TYPE_INVALID`, `COMBAT_ATTACK_UNRESOLVABLE`, `COMBAT_EFFECTS_INVALID`, `COMBAT_NOT_ACTIVE`, `COMBAT_NOT_YOUR_TURN`
